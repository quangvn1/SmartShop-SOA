                                            ...
                                            <c:forEach items="${listSpecial}" var="special">
                                                <div class="item-inner first">
                                                    ...
                                                    <div class="des-container">
                                                        <h2 class="product-name"><a href="productdetail?id=${special.id}">${special.name}</a></h2>
                                                        <div class="price-container">
                                                            <div class="new-price">
                                                    ...
                                                    <div class="box-hover">
                                                        <ul>
                                                            ...
                                                            <li><a href="#" class="compare">So sánh</a></li>
                                                                <c:if test="${user!=null}">
                                                                <li><a href="addtocart?id=${hot.id}&number=1" class="addtocart">Thêm giỏ hàng</a></li>
                                                                </c:if>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="des-container">
                                                    <h2 class="product-name"><a href="productdetail?id=${hot.id}">${hot.name}</a></h2>
                                                    <div class="price-container">
                                                        <div class="new-price">
                                                ...
                                                <div class="image-container">
                                                    ...
                                                    <div class="box-hover">
                                                        <ul>
                                                            ...
                                                            <li><a href="#" class="compare">So sánh</a></li>
                                                                <c:if test="${user!=null}">
                                                                <li><a href="addtocart?id=${saleOff.id}&number=1" class="addtocart">Thêm giỏ hàng</a></li>
                                                                </c:if>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="des-container">
                                                    <h2 class="product-name"><a href="productdetail?id=${saleOff.id}">${saleOff.name}</a></h2>
                                                    <div class="price-container">
                                                        <div class="new-price">
                                                ...
                                                <div class="image-container">
                                                    ...
                                                    <div class="box-hover">
                                                        <ul>
                                                            ...
                                                            <li><a href="#" class="compare">So sánh</a></li>
                                                                <c:if test="${user!=null}">
                                                                <li><a href="addtocart?id=${newProduct.id}&number=1" class="addtocart">Thêm giỏ hàng</a></li>
                                                                </c:if>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="des-container">
                                                    <h2 class="product-name"><a href="productdetail?id=${newProduct.id}">${newProduct.name}</a></h2>
                                                    <div class="price-container">
                                                        <div class="new-price">
