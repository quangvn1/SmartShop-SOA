        ...
        <div class="container">
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    <!-- Modal content-->
                    <form id="checkLogin" method="POST" action="checkLogin" autocomplete="off">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <form class="form-search" action="searchproduct" method="GET">
                    ...
                    <c:if test="${user!=null}">
                        <div class="cart">
                            <div class="cart-title">
                                ...
                                <span class="amount-cart">(${numberproductcart})</span>
                            </div>
                        </div>
                    </c:if>
                </div>
